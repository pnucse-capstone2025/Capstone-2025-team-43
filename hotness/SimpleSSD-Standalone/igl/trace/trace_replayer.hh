...
class TraceReplayer : public IOGenerator {
 private:
  ...
  //add
  bool useHex = false;
  bool useLBAOffset = false;
  bool useLBALength = false;
  uint32_t lbaSize = 512;
  bool timeValids[5] = {false, false, false, false, false};
  ...
  struct TraceLine {
    ...
    TraceLine() : tick(0), offset(0), length(0), type(BIL::BIO_NUM),temperature(1) {}
  } linedata;
